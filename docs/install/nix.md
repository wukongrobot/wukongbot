...
[`scripts/package-mac-app.sh`](https://github.com/wukongrobot/wukongbot/blob/main/scripts/package-mac-app.sh) copies this template into the app bundle and patches dynamic fields
