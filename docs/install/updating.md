...
Notes:
- `pnpm build` matters when you run the packaged `moltbot` binary ([`moltbot.mjs`](https://github.com/wukongrobot/wukongbot/blob/main/moltbot.mjs)) or use Node to run `dist/`.
