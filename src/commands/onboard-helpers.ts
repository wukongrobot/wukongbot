...
export function printWizardHeader(runtime: RuntimeEnv) {
  const header = [
    `                             oooo                                          .o8                     .   `,
    `                             \`888                                         "888                   .o8   `,
    `oooo oooo    ooo oooo  oooo   888  oooo   .ooooo.  ooo. .oo.    .oooooooo  888oooo.   .ooooo.  .o888oo `,
    ` \`88. \`88.  .8"  \`888  \`888   888 .8P"   d88" \`88b \`888P"Y88b  888' \`88b   d88" \`88b d88" \`88b   888   `,
    `  \`88..]88..8"    888   888   888888.    888   888  888   888  888   888   888   888 888   888   888   `,
    `   \`888"\`888"     888   888   888 \`88b.  888   888  888   888  \`88bod8P"   888   888 888   888   888 . `,
    `    \`8"  \`8"      \`V88V"V8P" o888o o888o \`Y8bod8P" o888o o888o \`8oooooo.   \`Y8bod8P" \`Y8bod8P"   "888" `,
    `                                                               d"     YD                               `,
    `                                                               "Y88888P"                               `,
    `                                                                                                       `,
  ].join("\n");
