...
FEED_URL=${2:-"https://raw.githubusercontent.com/wukongrobot/wukongbot/main/appcast.xml"}
...
DOWNLOAD_URL_PREFIX=${SPARKLE_DOWNLOAD_URL_PREFIX:-"https://github.com/wukongrobot/wukongbot/releases/download/v${VERSION}/"}
