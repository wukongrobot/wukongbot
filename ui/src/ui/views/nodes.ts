    ...
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
          ...
          <div class="card-sub">已配对设备与实时链接。</div>
        </div>
    ...
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
          ...
          <div class="card-sub">配对请求与角色 Token。</div>
        </div>
  ...
  return html`
    <div class="list-item">
      <div class="list-main">
        ...
        ${tokens.length === 0
          ? html`<div class="muted" style="margin-top: 6px;">Tokens：无</div>`
          : html`
    ...
    <section class="card">
      <div class="row" style="justify-content: space-between; align-items: center;">
        <div>
          ...
          <div class="card-sub">
            在使用 <span class="mono">exec host=node</span> 时，将 Agent 固定到指定节点。
          </div>
        </div>
        <button
          class="btn"
      ...
      ${state.formMode === "raw"
        ? html`<div class="callout warn" style="margin-top: 12px;">
            将“配置”页切换到 <strong>表单</strong> 模式，才能在此编辑绑定。
          </div>`
        : nothing}

      ${!state.ready
        ? html`<div class="row" style="margin-top: 12px; gap: 12px;">
            <div class="muted">加载配置后才能编辑绑定。</div>
            ...
            <div class="list" style="margin-top: 16px;">
              <div class="list-item">
                <div class="list-main">
                  ...
                  <div class="list-sub">当 Agent 未设置覆盖绑定时使用。</div>
                </div>
                <div class="list-meta">
                  <label class="field">
                    <span>节点</span>
...
function renderExecApprovals(state: ExecApprovalsState) {
  ...
  return html`
    <section class="card">
      ...
      ${!ready
        ? html`<div class="row" style="margin-top: 12px; gap: 12px;">
            <div class="muted">加载 Exec 审批后才能编辑白名单。</div>
  ...
  return html`
    <div class="list" style="margin-top: 12px;">
      ...
      ${state.target === "node" && !hasNodes
        ? html`<div class="muted">暂无节点提供 Exec 审批能力。</div>`
        : nothing}
    </div>
  `;
}
